...
- **Clawd Bot** — `https://cheshireterminal.ai/zeroclawd`
...
- **ZK Go package** — `pkg/zkomni` wraps `@clawd/zk-shark-agent` at `zk-primitives/agent` plus RH↔Solana msgType-4 proofs
