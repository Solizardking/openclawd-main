...
`ooda/` is the **Clawd Bot** observe → orient → decide → act harness: agent pulse checks, journals, and optional TUI. **Paper-trading and devnet only** — no real funds, no mainnet connections.
