...
- Format converters: `fromClawdMessages`, `toClawdMessage`, `fromChatMessages`, `toChatMessage`
...
| Old | New |
|-----|-----|
| `import { fromClawdMessages, toClawdMessage } from '@openrouter/sdk'` | `import { fromClawdMessages, toClawdMessage } from '@openrouter/agent'` |
...
| `@openrouter/agent/anthropic-compat` | `fromClawdMessages`, `toClawdMessage` |
