...
metadata: {"source":"https://github.com/Lightprotocol/skills","documentation":"https://www.zkcompression.com"}
---
...
**Nullifier:**
- [nullifier-program](https://github.com/Lightprotocol/nullifier-program) — Rent-free PDA for duplicate execution prevention. SDK: [`light-nullifier-program`](https://docs.rs/light-nullifier-program) | [example client](https://github.com/Lightprotocol/examples-zk-compression)
